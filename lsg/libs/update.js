 ...
 * 升级文件为JSON格式数据，如下：
{
    ...
    "iOS":{
    	...
    	"url":"Appstore路径，如：itms-apps://itunes.apple.com/cn/app/LSG-h5+/id682211190?l=zh&mt=8"
    },
    "Android":{
    	"version":"Android新版本号，如：1.0.1",
    	"note":"Android新版本描述信息，多行使用\n分割",
    	"url":"apk文件下载地址，如：http://www.dcloud.io/LSGh5p/LSGH5.apk"
    }
}
 *
 */
(function(w){
var server=CONSTANTS_BASE.BASE_URL+"/fruitupload/app/lsg/update.json",//获取升级描述文件服务器地址
localDir="update",
...
if ( w.plus ) {
	...
	console.log("开始初始化更新方法");
	document.addEventListener("resume", function() {
		console.log("应用从后台切换到前台啦啦");
		initUpdate();
	}, false);
//	document.addEventListener("resume", function() {
